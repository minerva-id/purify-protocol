...
// Language Switcher Component untuk Whitepaper
function WhitepaperLanguageSwitcher() {
        ...
        >
            ...
            <div className="space-y-8">
              ...
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4 flex items-center space-x-2">
                  ...
                  <span>{wp('introduction').problem.title}</span>
                </h3>
                <p className="text-gray-300 mb-4">
                  {wp('introduction').problem.description}
                </p>
                <ul className="text-gray-300 space-y-2 ml-6">
                  {wp('introduction').problem.points.map((point, index) => (
              ...
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4 flex items-center space-x-2">
                  ...
                  <span>{wp('introduction').solution.title}</span>
                </h3>
                <p className="text-gray-300 mb-4">
                  {wp('introduction').solution.description}
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  {wp('introduction').solution.points.map((point, index) => (
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-emerald-400 mb-6 border-b border-emerald-700/30 pb-2 flex items-center space-x-2">
              ...
              <span>{wp('technical').title}</span>
            </h2>
            
            <div className="space-y-8">
              {/* Smart Contract Design */}
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('technical').design.title}</h3>
                <p className="text-gray-300 mb-4">
                  {wp('technical').design.description}
                </p>
                <div className="bg-black/30 rounded-lg p-6 border border-emerald-500/20 font-mono text-sm">
                  {wp('technical').design.code.map((line, index) => (
              ...
              {/* Account Structure */}
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('technical').accounts.title}</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  {wp('technical').accounts.items.map((item, index) => (
              ...
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4 flex items-center space-x-2">
                  ...
                  <span>{wp('technical').security.title}</span>
                </h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {wp('technical').security.features.map((feature, index) => (
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-emerald-400 mb-6 border-b border-emerald-700/30 pb-2 flex items-center space-x-2">
              ...
              <span>{wp('economic').title}</span>
            </h2>
            
            <div className="space-y-8">
              {/* Value Proposition */}
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('economic').value.title}</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
                    <h4 className="text-lg font-semibold text-emerald-400 mb-3">{wp('economic').value.holders.title}</h4>
                    <ul className="text-gray-300 space-y-2">
                      {wp('economic').value.holders.points.map((point, index) => (
                        <li key={index} className="flex items-start space-x-2">
                  ...
                  <div className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
                    <h4 className="text-lg font-semibold text-emerald-400 mb-3">{wp('economic').value.ecosystem.title}</h4>
                    <ul className="text-gray-300 space-y-2">
                      {wp('economic').value.ecosystem.points.map((point, index) => (
                        <li key={index} className="flex items-start space-x-2">
              ...
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('economic').certificates.title}</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {wp('economic').certificates.points.map((item, index) => (
                    <div key={index} className="bg-white/5 rounded-lg p-4 border border-emerald-500/20">
                      <div className="flex items-center space-x-2">
              ...
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('economic').sustainability.title}</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  {wp('economic').sustainability.points.map((item, index) => (
                    <div key={index} className="bg-white/5 rounded-lg p-4 border border-emerald-500/20 text-center">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {wp('useCases').items.map((useCase, index) => (
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold text-emerald-400 mb-6 border-b border-emerald-700/30 pb-2 flex items-center space-x-2">
              ...
              <span>{wp('roadmap').title}</span>
            </h2>
            
            <div className="space-y-6">
              {wp('roadmap').phases.map((phase, index) => (
                <div key={index} className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-8">
              {/* PURIFY Token */}
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('tokenomics').purifyToken.title}</h3>
                <p className="text-gray-300 mb-4">
                  {wp('tokenomics').purifyToken.description}
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  {wp('tokenomics').purifyToken.features.map((item, index) => (
                    <div key={index} className="bg-white/5 rounded-lg p-4 border border-emerald-500/20 text-center">
              ...
              {/* Certificate NFTs */}
              <div>
                <h3 className="text-2xl font-semibold text-white mb-4">{wp('tokenomics').certificates.title}</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  {wp('tokenomics').certificates.points.map((item, index) => (
                    <div key={index} className="flex items-start space-x-2">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
                <h3 className="text-xl font-semibold text-white mb-4">{wp('team').development.title}</h3>
                <ul className="text-gray-300 space-y-2">
                  {wp('team').development.points.map((point, index) => (
                    <li key={index} className="flex items-start space-x-2">
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
                <h3 className="text-xl font-semibold text-white mb-4">{wp('team').governance.title}</h3>
                <ul className="text-gray-300 space-y-2">
                  {wp('team').governance.points.map((point, index) => (
                    <li key={index} className="flex items-start space-x-2">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6">
              {wp('risks').categories.map((riskCategory, index) => (
                <div key={index} className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
          ...
          <section className="mb-12">
            ...
            <div className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
              {wp('conclusion').content.map((paragraph, index) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white/5 rounded-xl p-6 border border-emerald-500/20">
                ...
                <div className="space-y-3">
                  {wp('contact').resources.map((resource, index) => (
