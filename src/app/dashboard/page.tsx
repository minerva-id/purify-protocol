...
import { Coins, Trophy, TrendingUp, Activity, Zap, Sparkles, Languages, Home } from "lucide-react";
...
import CertificateMinting from '@/components/CertificateMinting';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#03150f] via-[#09261f] to-[#010a07] text-white flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <div className="mt-6">
            <WalletMultiButton className="!bg-emerald-600 hover:!bg-emerald-700 !text-white !px-6 !py-3 !rounded-lg !mx-auto" />
          </div>
        </div>
      </div>
    );
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <ImageLogo />
              <motion.button
                className="text-emerald-300 hover:text-white transition-colors flex items-center space-x-2 px-4 py-2 border border-emerald-800/30 rounded-lg hover:border-emerald-600/50"
